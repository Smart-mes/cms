<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/mobile/lists_guestbook.htm";i:1572588518;s:42:"D:\work\php\cms\template\mobile\header.htm";i:1572835079;s:42:"D:\work\php\cms\template\mobile\footer.htm";i:1571994315;}*/ ?>
<!doctype html>
<html>
    ...
    <div class="am-offcanvas-bar am-offcanvas-bar-flip">
      <ul id="collapase-nav">
        ...
        <li class="am-panel"> <span class="am-icon-angle-right"
            data-am-collapse="{parent:'#collapase-nav', target:'#nav_a<?php echo $i; ?>'}"></span> <a href="<?php echo $field['typeurl']; ?>"
            title="<?php echo $field['typename']; ?>"><?php echo $field['typename']; ?></a>
    ...
    <section>
      ...
      <form method="POST" class="am-form am-form-horizontal form-add" enctype="multipart/form-data"
        ...
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label"><?php echo $field['itemname_24']; ?><span class="colour-red">*</span></label>
          <div class="am-u-sm-9">
            <input type="text" name="<?php echo $field['attr_24']; ?>" id="attr_24" size="20" value="">
            <span for="my_title" class="msg-box"></span> </div>
        </div>
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label"><?php echo $field['itemname_26']; ?><span class="colour-red">*</span></label>
          <div class="am-u-sm-9">
        ...
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label"><?php echo $field['itemname_28']; ?><span class="colour-red">*</span></label>
          <div class="am-u-sm-9">
        ...
        <div class="am-form-group">
          ...
          <div class="am-u-sm-9">
            <input type="text" name="<?php echo $field['attr_30']; ?>" id="attr_30" size="20" maxlength="20" value="">
            <span for="my_truename" class="msg-box"></span> </div>
        </div>
        <div class="am-form-group">
          <label class="am-u-sm-3 am-form-label"><?php echo $field['itemname_32']; ?><span class="colour-red">*</span></label>
          <div class="am-u-sm-9">
            <textarea name="<?php echo $field['attr_32']; ?>" id="attr_32" rows="6" size="50" maxlength="300" value=""></textarea>
            <span for="my_truename" class="msg-box"></span> </div>
        </div>
      ...
      <script type="text/javascript">
        function checkForm() {
          ...
          if (document.getElementById('attr_24').value.length == 0) {
            alert('<?php echo $field['itemname_24']; ?>不能为空！');
            return false;
          }
          if (document.getElementById('attr_26').value.length == 0) {
            alert('<?php echo $field['itemname_26']; ?>不能为空！');
            return false;
          }
          if (phoneValue.length == 0) {
            alert('<?php echo $field['itemname_28']; ?>不能为空！');
            return false;
          }
          if (document.getElementById('attr_32').value.length == 0) {
            alert('<?php echo $field['itemname_32']; ?>不能为空！');
            return false;
          }
