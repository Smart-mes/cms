<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/system\smtp.htm";i:1573116806;s:60:"D:\work\php\cms\application\admin\template\public\layout.htm";i:1571037616;s:57:"D:\work\php\cms\application\admin\template\system\bar.htm";i:1571037616;s:60:"D:\work\php\cms\application\admin\template\public\footer.htm";i:1571037616;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="min-width:auto;">
    <?php if(empty($iframes) || (($iframes instanceof \think\Collection || $iframes instanceof \think\Paginator ) && $iframes->isEmpty())): if(\think\Request::instance()->param('tabase') != '-1'): ?>
    <div class="fixed-bar">
...
<?php endif; endif; ?>
    <div class="flexigrid">
        <?php if(empty($iframes) || (($iframes instanceof \think\Collection || $iframes instanceof \think\Paginator ) && $iframes->isEmpty())): ?>
        <div class="mDiv">
            <div class="ftitle">
                <h3>接口配置</h3>
            </div>
            ...
            <div class="sDiv">
                <div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
                    <input type="button" class="btn selected" value="邮件配置" onclick="window.location.href='<?php echo url("System/smtp"); ?>';">
                </div>
            </div>
        </div>
        <?php endif; ?>
            ...
            <div class="ncap-form-default">
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <p class="">使用发送邮件的邮箱授权码。具体请点击参看【<a href="https://www.eyoucms.com/plus/view.php?aid=5552" target="_blank">使用指南</a>】</p>
                    </dd>
                </dl>
                <dl class="row">
                ...
                <div class="bot">
                    <input type="hidden" name="iframes" value="<?php echo $iframes; ?>">
