<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"./template/pc/view_recruit.htm";i:1573181491;s:38:"D:\work\php\cms\template\pc\header.htm";i:1572513233;s:38:"D:\work\php\cms\template\pc\banner.htm";i:1571037616;s:38:"D:\work\php\cms\template\pc\footer.htm";i:1572514955;}*/ ?>
<!doctype html>
<html>
			...
			<li>
				...
				<div class="txt">
					<a href="<?php echo $field['arcurl']; ?>"
						title="<?php echo $field['title']; ?>"><?php echo $field['title']; ?></a><?php echo html_msubstr($field['seo_description'],0,60,true); ?>
				</div>
			</li>
		...
		<div id="yingpin-popup">
			<div class="job-popup">
				...
				<form method="POST" class="am-form am-form-horizontal form-add" enctype="multipart/form-data"
					...
					<dl>
						<dt><?php echo $field['itemname_34']; ?></dt>
						<dd><input type="text" value="<?php echo $eyou['field']['title']; ?>" name="<?php echo $field['attr_34']; ?>" id="attr_34"></dd>
					</dl>
					<dl>
						<dt><?php echo $field['itemname_36']; ?><span class="colour-red">*</span></dt>
						<dd><input type="text" value="" name="<?php echo $field['attr_36']; ?>" id="attr_36"></dd>
					</dl>
					<dl>
						<dt><?php echo $field['itemname_38']; ?><span class="colour-red">*</span></dt>
						<dd>
							<select name="<?php echo $field['attr_38']; ?>" id="attr_38">
								<option value="">请选择性别</option>
								<?php if(is_array($field['options_38']) || $field['options_38'] instanceof \think\Collection || $field['options_38'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options_38'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
					...
					<dl>
						<dt><?php echo $field['itemname_40']; ?><span class="colour-red">*</span></dt>
						<dd><input type="text" value="" name="<?php echo $field['attr_40']; ?>" id="attr_40"></dd>
					</dl>
					<dl>
						<dt><?php echo $field['itemname_44']; ?><span class="colour-red">*</span></dt>
						<dd>
							<select name="<?php echo $field['attr_44']; ?>" id="attr_44">
								<option value="">请选择学历</option>
								<?php if(is_array($field['options_44']) || $field['options_44'] instanceof \think\Collection || $field['options_44'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options_44'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
								<option value="<?php echo $vo['value']; ?>"><?php echo $vo['value']; ?></option>
								<?php echo isset($vo["ey_1563185380"])?$vo["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($vo["ey_1563185376"]))?$vo["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $vo = []; ?>
							</select>
						</dd>
					...
					<dl>
						<dt><?php echo $field['itemname_46']; ?></dt>
						<dd><textarea name="<?php echo $field['attr_46']; ?>" id="attr_46" rows="3" cols="50"></textarea></dd>
					</dl>
					<dl>
						<dt></dt>
				...
				<script type="text/javascript">
					function checkForm() {
						var phoneValue = document.getElementById('attr_40').value;

						if (document.getElementById('attr_36').value.length == 0) {
							alert('<?php echo $field['itemname_36']; ?>不能为空！');
							return false;
						}
						if (document.getElementById('attr_38').value.length == 0) {
							alert('<?php echo $field['itemname_38']; ?>不能为空！');
							return false;
						}
						if (phoneValue.length == 0) {
							alert('<?php echo $field['itemname_40']; ?>不能为空！');
							return false;
						}
						if (document.getElementById('attr_44').value.length == 0) {
							alert('<?php echo $field['itemname_44']; ?>不能为空！');
							return false;
						}
						// 其他验证
