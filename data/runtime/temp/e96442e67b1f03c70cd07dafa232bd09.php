<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:33:"./template/pc/lists_guestbook.htm";i:1572588632;s:38:"D:\work\php\cms\template\pc\header.htm";i:1572513233;s:38:"D:\work\php\cms\template\pc\banner.htm";i:1571037616;s:38:"D:\work\php\cms\template\pc\footer.htm";i:1572514955;}*/ ?>
<!doctype html>
<html>
  ...
  <div class="width inner_container">
    ...
    <form method="POST" class="am-form am-form-horizontal form-add form_message" enctype="multipart/form-data"
      ...
      <div class="am-form-group">
        <label class="am-u-sm-2 am-form-label"><?php echo $field['itemname_24']; ?><span class="colour-red">*</span></label>
        <div class="am-u-sm-10">
          <input type="text" name="<?php echo $field['attr_24']; ?>" id="attr_24" size="50" value="">
          <span for="my_title" class="msg-box"></span> </div>
      </div>
      <div class="am-form-group">
        <label class="am-u-sm-2 am-form-label"><?php echo $field['itemname_26']; ?><span class="colour-red">*</span></label>
        <div class="am-u-sm-10">
      ...
      <div class="am-form-group">
        <label class="am-u-sm-2 am-form-label"><?php echo $field['itemname_28']; ?><span class="colour-red">*</span></label>
        <div class="am-u-sm-10">
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-10">
          <input type="text" name="<?php echo $field['attr_30']; ?>" id="attr_30" size="50" maxlength="20" value="">
          <span for="my_truename" class="msg-box"></span> </div>
      </div>
      <div class="am-form-group">
        <label class="am-u-sm-2 am-form-label"><?php echo $field['itemname_32']; ?><span class="colour-red">*</span></label>
        <div class="am-u-sm-10">
